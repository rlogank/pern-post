    ...
    <>
      {open && (
        <div
          className={
            dark
              ? "w-full justify-between self-start rounded-md bg-slate-800 p-5 text-slate-100"
              : "w-full justify-between self-start rounded-md bg-emerald-600 p-5 text-slate-100"
          }
        >
          <div className="mb-3 flex items-center justify-between">
            <h2 className="font-bold leading-3">
              {capitalizeFirstLetter(location.pathname.replace("/s/", ""))}
            </h2>
